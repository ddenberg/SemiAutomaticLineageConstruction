function P = ConstrainedMinimization(X0, A1, A2, B1, B2, lambda, division_constraints, lineage_constraints)
...
if ~isempty(lineage_constraints)
%     temp_Aeq_N1(lineage_constraints(:,1)) = 0;
